...
#pragma omp parallel
	...
	char array1[4000000];
	// time distance: 200000, frequency: 2 M 
	...
	// time distance: 500000, frequency: 5 M 
	__asm__ __volatile__ ("movl $10, %%edx\n\t"
		"loop3:\n\t"
		"movl $500000, %%eax\n\t"
		"movq %%rcx, %%rbx\n\t"
	...
	__asm__ __volatile__ ("movl $10, %%edx\n\t"
        ...
        // time distance: 4000000, frequency: 40 M 
	__asm__ __volatile__ ("movl $10, %%edx\n\t"
		"loop9:\n\t"
		"movl $4000000, %%eax\n\t"
		"movq %%rcx, %%rbx\n\t"
