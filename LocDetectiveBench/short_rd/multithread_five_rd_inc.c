...
#pragma omp parallel
	...
	int array4[600];
	int array5[1500];
	// time distance: 50, frequency: 5 M 
	__asm__ __volatile__ ("movl $100000, %%edx\n\t"
        ...
        // time distance: 100, frequency: 10 M 
	__asm__ __volatile__ ("movl $100000, %%edx\n\t"
                "loop3:\n\t"
                "movl $100, %%eax\n\t"
                "movq %%rcx, %%rbx\n\t"
        ...
        // time distance: 300, frequency: 30 M 
	__asm__ __volatile__ ("movl $100000, %%edx\n\t"
                "loop4:\n\t"
                "movl $300, %%eax\n\t"
                "movq %%rcx, %%rbx\n\t"
	...
	__asm__ __volatile__ ("movl $100000, %%edx\n\t"
        ...
        // time distance: 1500, frequency: 150 M
        __asm__ __volatile__ ("movl $100000, %%edx\n\t"
                "loop8:\n\t"
                "movl $1500, %%eax\n\t"
                "movq %%rcx, %%rbx\n\t"
